...
def _flash_scaled_dot_product_attention(query: Tensor, key: Tensor, value: Tensor, cum_seq_q: Tensor, cum_seq_k: Tensor, max_q: _int, max_k: _int, dropout_p: _float, is_causal: _bool) -> Tensor: ...
...
__all__ = ['__and__', '__lshift__', '__or__', '__rshift__', '__xor__', '_adaptive_avg_pool2d',
 ...
 '_debug_has_internal_overlap', '_dim_arange', '_dirichlet_grad', '_efficientzerotensor',
 ...
 '_flash_scaled_dot_product_attention', '_foobar', '_foreach_abs', '_foreach_abs_', '_foreach_acos',
 ...
 '_foreach_trunc_', '_foreach_zero_', '_from_functional_tensor', '_fused_adam_', '_fused_dropout',
 ...
 '_mps_convolution', '_mps_convolution_transpose', '_mps_max_pool2d',
 ...
 '_scaled_dot_product_attention_math', '_shape_as_tensor', '_sobol_engine_draw',
