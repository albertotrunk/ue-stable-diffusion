...
namespace symint {
  ...
  at::Tensor select_backward(const at::Tensor & grad_output, c10::SymIntArrayRef input_sizes, int64_t dim, int64_t index) {
    return at::_ops::select_backward::call(grad_output, input_sizes, dim, index);
  }
}
...
namespace symint {
  template <typename T, typename = std::enable_if_t<std::is_same<T, c10::SymInt>::value>>
  at::Tensor & select_backward_out(at::Tensor & out, const at::Tensor & grad_output, c10::SymIntArrayRef input_sizes, int64_t dim, int64_t index) {
    return at::_ops::select_backward_out::call(grad_output, input_sizes, dim, index, out);
  }
}
...
namespace symint {
  template <typename T, typename = std::enable_if_t<std::is_same<T, c10::SymInt>::value>>
  at::Tensor & select_backward_outf(const at::Tensor & grad_output, c10::SymIntArrayRef input_sizes, int64_t dim, int64_t index, at::Tensor & out) {
    return at::_ops::select_backward_out::call(grad_output, input_sizes, dim, index, out);
  }
}
