...
namespace at {
namespace native {
TORCH_API at::Tensor & upsample_nearest3d_vec_out_symint(const at::Tensor & input, at::OptionalSymIntArrayRef output_size, c10::optional<at::ArrayRef<double>> scale_factors, at::Tensor & out);
