...
config = "C:/Users/alber/OneDrive/Escritorio/model/v1-inference.yaml"
ckpt = "C:/Users/alber/OneDrive/Escritorio/model/model.ckpt"
...
with unreal.ScopedSlowTask(4, "Loading weights") as slow_task3:
...
unreal.log(f"Samples finished in {0:.2f} minutes and exported to {sample_path}/n Seeds used {seeds[:-1]}")
